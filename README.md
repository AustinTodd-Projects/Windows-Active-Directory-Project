...
- Logged in with domain user account  | [User Domain Login](Server-Configuration/Client-Workstation/login.png)
- Tested network file sharing  | [User Domain Login](Server-Configuration/Client-Workstation/network-map-attempt.png)
